...
const form = useForm({
  ...
  hour_price: props.workOrder.hour_price,
});

const submit = () => {
  form.patch(route('work-orders.update', props.workOrder.id));
};
</script>
  ...
  <AppLayout title="Edit work order">
    <div class="space-y-6">
      <div class="flex items-center justify-between">
        <h1 class="text-2xl font-medium text-gray-900">Edit work order</h1>
